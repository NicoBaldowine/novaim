...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <BrandPrinciples />
      <section className="identity section" id="identity"><div className="identity-heading"><h2>The identity</h2><p>One signal. A connected identity. A circular core extends into a sequence of curved forms, giving connection a clear direction. The geometric wordmark carries that rhythm through precise lines and softened corners. Calm backgrounds give the points room to breathe; green and lilac make their relationships visible.</p></div><IdentityBento /></section>
