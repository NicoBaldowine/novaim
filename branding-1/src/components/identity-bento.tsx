...
export function IdentityBento() {
  ...
  return <div className="identity-bento living-bento" ref={root}>
    ...
    <div className="bento-mockup bento-social-profile">
      <Image src="/mockups/novaim-social-profile-v3.png" alt="NovaIM social profile with a dotted sphere cover, constellation avatar, and Connecting points. Creating possibilities." fill sizes="(max-width: 700px) 88vw, 30vw" />
    </div>
