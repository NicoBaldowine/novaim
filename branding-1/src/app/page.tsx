...
export default function Home() {
  return <>
    ...
    <main>
      ...
      <BrandPrinciples />
      <section className="identity section" id="identity"><div className="identity-heading"><h2>The identity</h2><p>Distinct capabilities. One connected identity. Four equal forms turn around a shared centre, expressing continuous exchange within one intelligence system. The rounded wordmark gives that connection a clear, human voice. Calm backgrounds give the points room to breathe; green and lilac make their relationships visible.</p></div><IdentityBento /></section>
